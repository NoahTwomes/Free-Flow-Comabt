                                 ...
                                 const FAnimNotifyEventReference& EventReference)
{
	...
	if(MeshComp->GetOwner())
	{
		...
		UBlackboardComponent* BlackboardComp = UAIBlueprintHelperLibrary::GetBlackboard(MeshComp->GetOwner());
		...
		if(BlackboardComp)
		{
			...
			if(Value)
			{
				//Cast to character using the value from the blackboard function
